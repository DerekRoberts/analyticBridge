...
/**
 * Returns an object that contains the information for handling of queries.
 * 
 * @returns {object} an object that contains the information for handling of queries.
 */
var getQueries = function() {
    return connectionsConfigFile.queries;
};
